 ...
 */
public abstract class Generic_AbstractAgeGenderPlotApplet extends Generic_AbstractPlotApplet {
...
//        }
     ...
     * @param partTitleGap
     * @return 
     * @see <code>Generic_AbstractAgeGenderPlot.drawYaxis(int,int,int,int,int,int)</code>.
     */
    @Override
     ...
     * @param partTitleGap
     * @return 
     * @see <code>Generic_AbstractAgeGenderPlot.drawXaxis(int,int,int,int)</code>.
     */
    @Override
